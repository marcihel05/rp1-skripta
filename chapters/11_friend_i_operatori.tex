...
budući da na njih ne utječe kontrola pristupa
...
(budući da deklaracija unaprijed ne daje informaciju o tome koje funkcije članice klasa \texttt{Kolegij} sadrži):
\begin{minted}{C++}
class Kolegij; // deklaracija unaprijed klase Kolegij
class Profesor {
...
\begin{rjesenje}
    ...
    indeksiranja biti funkcije članica klase \texttt{Matrica}, dodajemo
...
\begin{rjesenje}
    ...
    \texttt{()} moraju biti funkcije članica klase \texttt{Matrica}, dodajemo
    njihove deklaracije u tu klasu (u datoteci \textit{Matrica.h}):
...
\begin{rjesenje}
    ...
    inkrementiranja implementirat ćemo kao funkcije članica klase \texttt{Matrica}.
    Dodajemo
    njihove deklaracije u tu klasu (u datoteci \textit{Matrica.h}):
